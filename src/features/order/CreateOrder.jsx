    ...
    <div className="px-4 py-6">
      ...
      <Form method="POST">
        ...
        <div className="mb-5 flex flex-col gap-2 sm:flex-row sm:items-center relative">
          ...
          {!position.longitude&&!position.latitude&&<span className='absolute right-0 top-0.25
           z-3'>
        ...
        <div className="mb-12 flex items-center gap-5">
          ...
          <label htmlFor="priority" className="font-medium">
            Want to give your order priority? Extra 12$ applied.
          </label>
        </div>

        <div>
          <input type="hidden" name="cart" value={JSON.stringify(cart)} />
          <input type="hidden" name="position" value={position.longitute&&position.latitude?`${position.longitude}, ${position.latitude}`:""} />
